...
const QUICK_ACTIONS = [
  { href: "/topup", label: "Top Up", icon: "+", desc: "Fake gateway" },
    ...
    <>
      ...
      <div className={styles.grid}>
        ...
        <div className={styles.side}>
          ...
          <div className={`${styles.oceanNote} ocean-placeholder`}>
            <p className={styles.oceanTitle}>Calm, premium water banking</p>
            <p className={styles.oceanSub}>
              Scenic placeholder — swap this gradient for a real ocean image later.
            </p>
          </div>
        </div>
      </div>
