        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    daily_transaction_limit = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    daily_transaction_count_limit = table.Column<int>(type: "integer", nullable: false),
                    transactions_today = table.Column<int>(type: "integer", nullable: false),
                    amount_today = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    last_reset_date = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    version = table.Column<int>(type: "integer", nullable: false),
                    created_at = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    updated_at = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_customer_risks", x => x.risk_id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "ux_risk_customer",
                table: "customer_risks",
                column: "customer_id",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "ux_ledger_account_reference",
                table: "ledger_entries",
                columns: new[] { "account_id", "reference_id" },
                unique: true);
